...
def main():
    ...
    extractor.save_pdf_text('output/pdf_text.txt')  # Save PDF text separately
    ...
    print(f"\n📁 Output:")
    print(f"   • output/pdf_text.txt              (PDF text only)")
    print(f"   • output/premera_extracted.json    (Complete data)")
    print(f"   • output/premera_summary.txt       (Readable summary with everything)")
